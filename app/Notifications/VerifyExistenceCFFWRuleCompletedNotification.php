...
class VerifyExistenceCFFWRuleCompletedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toSlack($notifiable)
    {
        return (new SlackMessage)
            ...
            ->attachment(function ($attachment) {
                $attachment->fields([
                               'Task' => 'Verify existence of a firewall rule for Cloudflare zones',
